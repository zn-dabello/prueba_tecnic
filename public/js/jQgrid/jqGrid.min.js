...
d=$.extend(!0,{url:"",height:150,page:1,rowNum:20,rowTotal:null,records:0,pager:"",pgbuttons:!0,pginput:!0,colModel:[],rowList:[],colNames:[],sortorder:"asc",sortname:"",datatype:"json",mtype:"GET",altRows:!0,selarrrow:[],preserveSelection:!1,savedRow:[],shrinkToFit:!1,xmlReader:{},jsonReader:{},subGrid:!1,subGridModel:[],reccount:0,lastpage:0,lastsort:0,selrow:null,beforeSelectRow:null,onSelectRow:null,onSortCol:null,ondblClickRow:null,onRightClickRow:null,onPaging:null,onSelectAll:null,onInitGrid:null,loadComplete:null,gridComplete:null,loadError:null,loadBeforeSend:null,afterInsertRow:null,beforeRequest:null,beforeProcessing:null,onHeaderClick:null,viewrecords:!0,loadonce:!0,multiselect:!1,multikey:!1,multiboxonly:!1,multimail:!1,multiselectWidth:30,editurl:null,search:!1,caption:"",hidegrid:!0,hiddengrid:!1,postData:{},userData:{},treeGrid:!1,treeGridModel:"nested",treeReader:{},treeANode:-1,ExpandColumn:null,tree_root_level:0,prmNames:{page:"page",rows:"rows",sort:"sidx",order:"sord",search:"_search",nd:"nd",id:"id",oper:"oper",editoper:"edit",addoper:"add",deloper:"del",subgridid:"id",npage:null,totalrows:"totalrows"},forceFit:!1,gridstate:"visible",cellEdit:!1,cellsubmit:"remote",nv:0,loadui:"enable",toolbar:[!1,""],scroll:!0,deselectAfterSort:!0,scrollrows:!1,autowidth:!1,scrollOffset:$.jgrid.scrollbarWidth()+3,cellLayout:5,subGridWidth:20,gridview:!0,rownumWidth:35,rownumbers:!0,pagerpos:"center",recordpos:"right",footerrow:!1,userDataOnFooter:!1,headerrow:!1,userDataOnHeader:!1,hoverrows:!0,viewsortcols:[!1,"vertical",!0],resizeclass:"",autoencode:!1,remapColumns:[],ajaxGridOptions:{},direction:"ltr",toppager:!1,headertitles:!1,scrollTimeout:40,data:[],_index:{},grouping:!1,groupingView:{groupField:[],groupOrder:[],groupText:[],groupColumnShow:[],groupSummary:[],showSummaryOnHide:!1,sortitems:[],sortnames:[],summary:[],summaryval:[],plusicon:"",minusicon:"",displayField:[],groupSummaryPos:[],formatDisplayField:[],_locgr:!1},ignoreCase:!0,cmTemplate:{},idPrefix:"",multiSort:!1,minColWidth:33,scrollPopUp:!1,scrollTopOffset:0,scrollLeftOffset:"100%",scrollMaxBuffer:0,storeNavOptions:!1,regional:"en",styleUI:"jQueryUI",iconSet:"Iconic",responsive:!1,restoreCellonFail:!0,editNextRowCell:!1,colFilters:{},colMenu:!1,colMenuCustom:{},colMenuColumnDone:null,treeGrid_bigData:!1,treeGrid_rootParams:{otherData:{}},treeGrid_beforeRequest:null,treeGrid_afterLoadComplete:null,useNameForSearch:!1},$.jgrid.defaults,a);void
...
f,g,h=this,i=-1;if(h.grid&&(f=b,isNaN(b)?$(h.p.colModel).each(function(a){if(this.name===b)return f=this.name,i=a,!1}):i=parseInt(b,10),i>=0&&(g=$(h).jqGrid("getGridRowById",a))))if(d=$("td:eq("+i+")",g),c)e=d;else{try{e=$.unformat.call(h,d,{rowId:g.id,colModel:h.p.colModel[i]},i)}catch(a){e=$.jgrid.htmlDecode(d.html())}h.p.treeGrid&&e&&h.p.ExpandColumn===f&&(e=$("<div>"+e+"</div>").find("span:first").html())}}),e},getCellFormat:function(a,b,c){var
d,e=!1;return void
0===c&&(c=!1), this.each(function(){var
f,g,h=this,i=-1;if(h.grid&&(f=b,isNaN(b)?$(h.p.colModel).each(function(a){if(this.name===b)return f=this.name,i=a,!1}):i=parseInt(b,10),i>=0&&(g=$(h).jqGrid("getGridRowById",a))))if(d=$("td:eq("+i+")",g),c)e=d;else{e=$.jgrid.htmlDecode(d.html());h.p.treeGrid&&e&&h.p.ExpandColumn===f&&(e=$("<div>"+e+"</div>").find("span:first").html())}}),e},getCol:function(a,b,c){var
